...
function theme_customize_register($wp_customize) {
    ...
    $wp_customize->add_control('color_scheme', array(
        'label' => __('Color Scheme', 'yxist_mvp'),
        'section' => 'colors',
        'type' => 'select',
        'choices' => array(),
        'priority' => 1,
    ...
    for ($i = 1; $i <= 5; $i++) {
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "color_$i", array(
            'label' => sprintf(__('Color %s', 'yxist_mvp'), $i),
            'section' => 'colors',
        )));
    }
    ...
    $wp_customize->add_control('font_scheme', array(
        'label' => __('Font Scheme', 'yxist_mvp'),
        'section' => 'fonts',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_control('font_heading', array(
        'label' => __('Heading Font', 'yxist_mvp'),
        'section' => 'fonts',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_control('typography_scheme', array(
        'label' => __('Typography Scheme', 'yxist_mvp'),
        'section' => 'typography',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_control('typography_heading_weight', array(
        'label' => __('Heading Weight', 'yxist_mvp'),
        'section' => 'typography',
        'type' => 'select',
        'choices' => array(
            '100' => __('100 Thin', 'yxist_mvp'),
            '300' => __('300 Light', 'yxist_mvp'),
            '400' => __('400 Regular', 'yxist_mvp'),
            '500' => __('500 Medium', 'yxist_mvp'),
            '700' => __('700 Bold', 'yxist_mvp'),
            '900' => __('900 Black', 'yxist_mvp'),
        ),
    ));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'logo_width', array(
        'type' => 'number',
        'label' => __('Logo max width (px)', 'yxist_mvp'),
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'logo_height', array(
        'type' => 'number',
        'label' => __('Logo max height (px)', 'yxist_mvp'),
        'section' => 'title_tagline',
        'priority' => 9,
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'logo_link', array(
        'type' => 'url',
        'label' => __('Logo link href', 'yxist_mvp'),
        'section' => 'title_tagline',
        'priority' => 9,
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Cropped_Image_Control($wp_customize, 'custom_favicon', array(
        'label' => __('Favicon', 'yxist_mvp'),
        'section' => 'title_tagline',
        'priority' => 8,
        'height' => '64',
        'width' => '64',
        'button_labels' => array(
            'select' => __('Select favicon', 'yxist_mvp'),
            'change' => __('Change favicon', 'yxist_mvp'),
            'remove' => __('Remove', 'yxist_mvp'),
            'default' => __('Default', 'yxist_mvp'),
            'placeholder' => __('No favicon selected', 'yxist_mvp'),
            'frame_title' => __('Select favicon', 'yxist_mvp'),
            'frame_button' => __('Choose favicon', 'yxist_mvp'),
        ),
    )));
    ...
    $wp_customize->add_section('menu_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Theme options', 'yxist_mvp'),
        'panel' => 'nav_menus',
    ));
    ...
    $wp_customize->add_control('menu_trim_title', array(
        ...
        'label' => __('Trim long menu items', 'yxist_mvp'),
    ));
    ...
    $wp_customize->add_control('menu_trim_len', array(
        'type' => 'number',
        'section' => 'menu_options',
        'label' => __('Limit each item to [N] characters', 'yxist_mvp'),
    ));
    ...
    $wp_customize->add_control('submenu_trim_len', array(
        'type' => 'number',
        'section' => 'menu_options',
        'label' => __('Limit each subitem to [N] characters', 'yxist_mvp'),
    ));
    ...
    $wp_customize->add_control('menu_use_tag_filter', array(
        'type' => 'checkbox',
        'section' => 'menu_options',
        'label' => __('Apply menu item tag filter', 'yxist_mvp'),
    ));
    ...
    $wp_customize->add_control('menu_allowed_tags', array(
        'type' => 'text',
        'section' => 'menu_options',
        'label' => __('Allowed menu item tags', 'yxist_mvp'),
    ));
    ...
    $wp_customize->add_control('use_default_menu', array(
        'type' => 'checkbox',
        'section' => 'menu_options',
        'label' => __('Use not stylized menu', 'yxist_mvp'),
        'description' => __('Used standart wp_nav_menu when option is enabled (need for some third-party plugins).', 'yxist_mvp'),
    ));
    ...
    $wp_customize->add_control('excerpt_auto', array(
        ...
        'label' => __('Use auto excerpts', 'yxist_mvp'),
        'description' => __('Generate post excerpts automatically (When neither more-tag nor post excerpt is used)', 'yxist_mvp'),
    ));
    ...
    $wp_customize->add_control('excerpt_words', array(
        'type' => 'number',
        'section' => 'excerpt_options',
        'label' => __('Excerpt length (words)', 'yxist_mvp'),
    ));
    ...
    $wp_customize->add_control('excerpt_min_remainder', array(
        'type' => 'number',
        'section' => 'excerpt_options',
        'label' => __('Excerpt balance (words)', 'yxist_mvp'),
    ));
    ...
    $wp_customize->add_control('excerpt_strip_shortcodes', array(
        'type' => 'checkbox',
        'section' => 'excerpt_options',
        'label' => __('Remove shortcodes from excerpt', 'yxist_mvp'),
    ));
    ...
    $wp_customize->add_control('excerpt_use_tag_filter', array(
        'type' => 'checkbox',
        'section' => 'excerpt_options',
        'label' => __('Apply excerpt tag filter', 'yxist_mvp'),
    ));
    ...
    $wp_customize->add_control('excerpt_allowed_tags', array(
        'type' => 'text',
        'section' => 'excerpt_options',
        'label' => __('Allowed excerpt tags', 'yxist_mvp'),
    ));
    ...
    $wp_customize->add_control('show_morelink', array(
        'type' => 'checkbox',
        'section' => 'excerpt_options',
        'label' => __('Show More Link', 'yxist_mvp'),
    ));
    ...
    $wp_customize->add_control('morelink_template', array(
        'type' => 'text',
        'section' => 'excerpt_options',
        'label' => __('More Link Template', 'yxist_mvp'),
        'description' => sprintf(__('ShortTags: %s', 'yxist_mvp'), '[url], [text]'),
    ));
    ...
    $wp_customize->add_control('seo_og', array(
        'type' => 'checkbox',
        'section' => 'seo_options',
        'label' => __('Include Open Graph meta tags', 'yxist_mvp'),
    ));
    ...
    $wp_customize->add_control('seo_ld', array(
        'type' => 'checkbox',
        'section' => 'seo_options',
        'label' => __('Include schema.org JSON-LD syntax markup', 'yxist_mvp'),
    ));
        ...
        foreach ($templates_parameters as $templateIndex => $template_options) {
                ...
                if (isset($op['options'])) {
                    foreach ($op['options'] as $key => $option) {
                        if (strpos($key, $templateKey . 'Template') === 0) {
                            ...
                            $templatesOptions[$templateKey][$key] = __($option, 'yxist_mvp');
                        }
                    }
                }
            }
            if (!in_array($templateKey, $woocommerceTemplateNames) || (in_array($templateKey, $woocommerceTemplateNames) && theme_woocommerce_enabled())) {
                ...
                $wp_customize->add_control( 'theme_template_' . $template . '_' . $templateName . '-template', array(
                    ...
                    'label'       => __( $templateLabel, 'yxist_mvp' ),
                    'description' => '',
                ) );
            }
        }
    ...
    if (file_exists(get_template_directory() . '/shop/products.json')) {
        ...
        if (isset ($data['products']) && $data['products']) {
            $wp_customize->add_section('products_options', array(
                'capability' => 'edit_theme_options',
                'title' => __('E-Commerce Templates', 'yxist_mvp'),
                'priority' => 200,
            ));
            ...
            $wp_customize->add_control('links_title', array(
                ...
                'label' => __('Theme With E-Commerce Templates', 'yxist_mvp'),
...
</br></br>Please copy the following links and paste them into your CMS Menu Item.', 'yxist_mvp'),
            ));
            ...
            $wp_customize->add_control('products_info', array(
                'type' => 'text',
                'section' => 'products_options',
                'label' => __('Product List Page Template:', 'yxist_mvp'),
            ...
            $wp_customize->add_control('product_info', array(
                'type' => 'text',
                'section' => 'products_options',
                'label' => __('Product Details Page Template:', 'yxist_mvp'),
    ...
    $wp_customize->add_section('other_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Other settings', 'yxist_mvp'),
        'priority' => 200,
    ));
    ...
    $wp_customize->add_control('include_jquery', array(
        ...
        'label' => __('Use jQuery from theme', 'yxist_mvp'),
    ));
    ...
    $wp_customize->add_section('sidebar_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Sidebars', 'yxist_mvp'),
        'priority' => 100,
    ));

    $layouts_choices = array(
        '' => __('Default', 'yxist_mvp'),
        'left-sidebar' => __('Left', 'yxist_mvp'),
        'right-sidebar' => __('Right', 'yxist_mvp'),
        'none' => __('None', 'yxist_mvp'),
    );
    ...
    $wp_customize->add_control('sidebars_layout_blog', array(
        ...
        'label' => __('Blog Template', 'yxist_mvp'),
        'description' => __('Templates for displaying blogs, archives, search results', 'yxist_mvp'),
    ));
    ...
    $wp_customize->add_control('sidebars_layout_post', array(
        ...
        'choices' => $layouts_choices,
        'section' => 'sidebar_options',
        'label' => __('Post Template', 'yxist_mvp'),
        'description' => __('Templates for displaying single posts', 'yxist_mvp'),
    ));
    ...
    $wp_customize->add_control('sidebars_layout_default', array(
        ...
        'choices' => $layouts_choices,
        'section' => 'sidebar_options',
        'label' => __('Default Template', 'yxist_mvp'),
        'description' => __('Templates for displaying single pages and everything else', 'yxist_mvp'),
    ));
}
add_action('customize_register', 'theme_customize_register', 11);

function theme_print_sidebars_blog_caption() {
    printf('<h3>%s</h3>', __('Display sidebars on:', 'yxist_mvp'));
}
