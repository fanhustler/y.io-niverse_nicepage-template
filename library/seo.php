...
<?php
    ...
    $twitter_account = apply_filters('theme_twitter_account', '@name');
    if ($twitter_account) {
?>
...
function theme_ld_meta_tags() {
    ...
    $social_links = apply_filters('theme_social_links', array("https://facebook.com/name","https://twitter.com/name","https://instagram.com/name"));
...
function theme_color_meta_tags() {
    $theme_color = apply_filters('theme_color', '#0cbcf5');
